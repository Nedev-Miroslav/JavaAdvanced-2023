...
public class P08CustomComparator {
    public static void main(String[] args) {
        ...
        numberList.forEach(e -> {
            boolean b = num.test(e) ? evenList.add(e) : oddList.add(e);
        });

        evenList.sort(Integer::compare);
        oddList.sort(Integer::compare);

        Consumer<List<Integer>> toPrint = e -> e.forEach(n -> System.out.print(n + " "));

        toPrint.accept(evenList);
        toPrint.accept(oddList);
    }
}
